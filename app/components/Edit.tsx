  ...
  useEffect(() => {
    if (selectedEvent) {
      ...
      const startTimeStr =
        ...
        selectedEvent.midterm_startTime ||
        selectedEvent.final_startTime;
      ...
      const endTimeStr =
        ...
        selectedEvent.midterm_endTime ||
        selectedEvent.final_endTime;
      ...
      // กรณีไม่มี selectedEvent ให้รีเซ็ตค่าเริ่มต้น
      setFormData({
        id: "",
        timetable_id: 0,
        subject_id: "",
